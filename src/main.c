...
void profstr0(char* current_string) {
 size_t my_string_length = 0;
for(uint32_t index = 0; index < BIGNUM; index++) {
    my_string_length = stringLength(current_string, 0);//, false);
  }
  return;
}
...
int main(int argument_count, char** argument_vector) {
  ...
  char* haystack7 = "leetcode";
  char* needle7 = "leeto";


  char* haystack8 = "0leetcode";
  char* needle8 = "leet";
